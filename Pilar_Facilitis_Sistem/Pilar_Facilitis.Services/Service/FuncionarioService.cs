...
namespace Pilar_Facilitis.Services.Service
{
    public class FuncionarioService : IFuncionarioService
    {
        ...
        public FuncionarioService(IFuncionarioRepository repository, IUnidadeTrabalho unidadeTrabalho, IMapper mapper)
        {
        ...
        public async Task<Resposta> Adcionar(FuncionarioViewModel funcionarioViewModel)
        {
            try
            {
                ...
                var funcionarioDb = await _repository.InsereAsync(funcionarioModel);
        ...
        public async Task<Resposta> Atualizar(FuncionarioViewModel funcionarioViewModel)
        {
            try
            {
                ...
                await _repository.Edita(funcionarioModel);
                await _unidadeTrabalho.SalvaAlteracoesAsync();
        ...
        public async Task<Resposta> ObterPorID(Guid id)
        {
            try
            {
                ...
                var funcionario = await _repository.BuscaAsync(id);
        ...
        public async Task<Resposta> Remover(Guid id)
        {
            try
            {
                ...
                _repository.Exclui(funcionario);
                await _unidadeTrabalho.SalvaAlteracoesAsync();
                return resposta;
            }
            catch (Exception e)
